...
export class ConfigTlsVersion extends SelectFiled {
    constructor(versions) {
        ...
        this._label.innerHTML = 'Version de TLS'
    }
}
...
export class ConfigName extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer un NOMBRE de configuración')
        }
    }
}
...
export class ConfigDesc extends TextFiled {
    constructor(desc) {
        ...
        this._label.innerHTML = 'Descripcion'
    }
...
export class ConfigSni extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establecer un SNI para la configuración')
        }
    }
}
...
export class ConfigPayload extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Establezca un PAYLOAD para la configuración')
        }
    }
}
...
export class ConfigProxy extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Definir un PROXY para la configuración')
        }
    }
}
...
export class ConfigServer extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Definir un SERVIDOR para la configuración')
        }
    }
}
